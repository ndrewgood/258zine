...
import pics from '../images/ks.png'
import text from '../images/ks-text.svg'
...
const KatPage = () => (
  <Layout>
      <div style={{backgroundColor: "#FD8A91"}} class="artistBG"></div>
      <SEO title="(25/8) Kat Sours" />
      <div className="artistpage-nav">
        ...
        <Link to="/kat-sours" style={{color: color, fontWeight: "600"}}>Kat Sours</Link>
