...
import pics from '../images/rw.png'
import text from '../images/rw-text.svg'
...
const RomulusPage = () => (
  <Layout>
      <div style={{backgroundColor: "#EDEDED"}} class="artistBG"></div>
      <SEO title="(25/8) Romulus Wolf" />
      <div className="artistpage-nav">
        ...
        <Link to="/romulus-wolf" style={{color: color, fontWeight: "600"}}>Romulus Wolf</Link>
      ...
      <div className="artistpage-container">
        ...
        <img src={text} alt="" className="artistpage-name rw-text"/>
        <p className="artistpage-title" style={{color: color}}>Drag performance artist</p>
        <p className="artistpage-body" style={{color: color}}>Romulus Wolf, is a nonbinary drag performance artist, who performed as Amerys the Empress for the first time when they were seventeen years old at a local club in Milledgeville. On the car ride to the club, Wolf recalls, “I was at a red light, and I looked over and it was just this bitch with her jaw dropped and it was just so funny.”</p>
