...
import pics from '../images/bk.png'
import text from '../images/bk-text.svg'
...
const BenPage = () => (
  <Layout>
      <div style={{backgroundColor: "#D7DDD3"}} class="artistBG"></div>
      <SEO title="(25/8) Ben Krueger" />
      <div className="artistpage-nav">
        ...
        <Link to="/ben-krueger" style={{color: color, fontWeight: "600"}}>Ben Krueger</Link>
