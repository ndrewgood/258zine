...
import pics from '../images/joe.png'
import text from '../images/joe-text.svg'
...
const JosephPage = () => (
  <Layout>
      <div style={{backgroundColor: "#FFFFFF"}} class="artistBG"></div>
      <SEO title="(25/8) Joseph Olusola Edgar" />
      <div className="artistpage-nav">
        ...
        <Link to="/joseph-olusola-edgar" style={{color: color, fontWeight: "600"}}>Joseph Olusola Edgar</Link>
      </div>
